...
from models.MasterShift import MasterShift
...
class Attendance(Base):
    ...
    wilayah = Column(String(255), nullable=True)
    outlet_name = Column(String(255), nullable=True)
    shift_id = Column(Integer, ForeignKey("master_shift.id"), nullable=True)
    ...
    history_activity_emp = relationship("HistoryActivityEmp", back_populates="attendance_history")
    master_shift = relationship("MasterShift", back_populates="attendances")
