...
class Payroll(Base):
    ...
    monthly_paid = Column(Numeric(15, 5), nullable=True)
    total_compensation = Column(Numeric(15, 5), nullable=True)
    tunjangan_jabatan = Column(Numeric(15, 5), nullable=True)
    total_allowances = Column(Numeric(15, 5), nullable=True)
    total_bpjs = Column(Numeric(15, 5), nullable=True)
    total_tax = Column(Numeric(15, 5), nullable=True)
    net_salary = Column(Numeric(15, 5), nullable=True)
    ...
    notifications = relationship("Notification", back_populates="payslip")
